...
const RULES = [
  ...
  "Team size: 2 to 4 members. Cross-college teams are not permitted. Team composition is locked at check-in.",
  "Entry fee is ₹300 per team, payable via the QR code on the event poster at registration. Non-refundable.",
  "Teams may choose any of the 15 problem statements from any of the 3 tracks; all are judged on equal footing. Statement/track changes after Checkpoint 1 are not permitted.",
  "Advancement past each checkpoint is decided solely on that round's fixed checklist, verified by mentors. Teams not meeting the checklist by the checkpoint time are eliminated at that gate.",
  "The twist is released simultaneously to all teams during Round 2 (Hr 3:00). Integrating it is mandatory for advancement to Round 3 and is the primary basis for the Adaptability/Pivot Handling score. No extensions.",
  ...
  "Plagiarism, use of a pre-built project, missing a checkpoint deadline, or code-of-conduct violations are grounds for immediate disqualification at the organizers' discretion.",
